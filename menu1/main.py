...
# --- Local modules (ALL prefixed with menu1.) ---
...
def render_menu() -> None:
    ...
    # --- Step 1 / 2 / 3 (handled by controls.py; behavior unchanged) ---
    ...
    # Keep both buttons left: two narrow columns + a large spacer to prevent centering
