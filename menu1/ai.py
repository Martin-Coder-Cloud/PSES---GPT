...
"- Avoid repeating detailed statistics already provided in per-question summaries. You may use at most one or two percentages in total, and only when they support a cross-question conclusion (e.g., “results remain above 70 % across these indicators”).\n"
