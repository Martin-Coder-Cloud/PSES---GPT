    ...
    if ai_on:
        ...
        if cached:
                ...
                if txt:
                    ...
                    try:
                        ...
                        if labels:
                            ...
                            if lab:
                                # CHANGED: escape leading asterisk so it's rendered as a literal '*'
            ...
            if overall_narrative and len(tab_labels) > 1:
                ...
                # Overall footnote (single line; do not repeat per-question items here)
                try:
                    # If at least one question has meaning_labels, show one overall footnote
                    first_q_with_labels = None
                    first_overall_lab = None
                    for q in tab_labels:
