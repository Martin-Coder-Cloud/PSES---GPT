...
- Optional AI narratives (per-question + overall) via ai.py
...
def tabs_summary_and_per_q(
    *,
    ...
    with tabs[0]:
        ...
        # Overall AI summary (only if multiple questions are present)
        if ai_on and len(tab_labels) > 1:
            with st.spinner("Generating Overall Summary Analysis…"):
                # Map question code -> metric label (e.g., "% positive")
